...
#set xzeroaxis
      ...
      set xr [1.0:20000.0]
      set yr [-5.0:4.1]
      plot"N1tot.dat" using 2:3 title "{/Times-Italic=18 a} = {/Symbol -}2386 a.u." with lines ls 4,  \
	 "N2tot.dat" using 2:3 title"{/Times-Italic=18 a} = {/Symbol -}8721 a.u." with lines ls 3,  \
	    "N3tot.dat" using 2:3 title"{/Times-Italic=18 a} = {/Symbol -}38612 a.u." with lines ls 2,  \
	       "N4tot.dat" using 2:3 title "{/Times-Italic=18 a} = {/Symbol -}2702020 a.u." with lines ls 1,  \
