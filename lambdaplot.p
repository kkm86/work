...
#set xzeroaxis
      ...
      set style line 2 dt 2 lc rgb 'blue' pt 2 
      ...
      set arrow from 1.0,-1.0125145 to 10000.0,-1.0125 nohead lw 1 dt 2 lc 'grey'
      ...
      set xr [1.0:20000.0]
      set yr [-5.0:4.1]
      plot"inftyneg.dat" using 2:3 title "{/Times:Italic=12 a_1" with lines ls 1,  \
	       "inftypos.dat" using 2:3 title"{/Times:Italic=12 a_2" with lines ls 2,  \
